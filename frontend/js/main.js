...
document.addEventListener("DOMContentLoaded", function () {
  const authLinkCanvas = document.getElementById("auth-link-canvas");
  ...
  const sellBookMenu = document.getElementById("sell-book-menu");
  const profileMenu = document.getElementById("profile-menu");

  if (token) {
    // If logged in, show "Logout" option
    authLinkCanvas.innerHTML = `<a href="#" id="logout-btn-canvas">Logout</a>
      `;
    authLinkHeader.innerHTML = `<a href="#" id="logout-btn-header">Logout</a>
      `;

    sellBookMenu.style.display = "inline-block";
    profileMenu.style.display = "inline-block";
    var currentUrl = window.location.pathname;

    // Add the event listener after dynamically creating the logout button
    document
      ...
      .addEventListener("click", function (e) {
        ...
        if (
          currentUrl.includes("wisslist") ||
          currentUrl.includes("checkout") ||
          currentUrl.includes("sell") ||
          currentUrl.includes("shoping-cart") ||
          currentUrl.includes("wishlist") ||
          currentUrl.includes("profile") ||
          currentUrl.includes("edit-book")
        ) {
    ...
    document
      .getElementById("logout-btn-canvas")
      .addEventListener("click", function (e) {
        e.preventDefault(); // Prevent the default link behavior
    ...
    sellBookMenu.style.display = "none";
    ...
    authLinkCanvas.innerHTML = logged_out_content;
    authLinkHeader.innerHTML = logged_out_content;
  }
});
